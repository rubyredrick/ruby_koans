...
class AboutMessagePassing < EdgeCase::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    #
    # Because sometimes a class wants to define a send method with a different meaning
    # So send can be overriden, but __send__ must never be.
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    #
    # method_missing would be invoked whenever a method was not found
  end
