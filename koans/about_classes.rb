...
class AboutClasses < EdgeCase::Koan
  ...
  def test_instance_variables_can_be_set_by_assigning_to_them
    # How well I know
    # See http://talklikeaduck.denhaven2.com/2008/02/08/whose-variable-is-it-anyway
    fido = Dog2.new
  ...
  def test_args_to_new_must_match_initialize
    ...
    # Why is this so?
    #
    # The new method in Class allocates the storage for the object and then
    # calls initialize with the same arguments it received.
  end
